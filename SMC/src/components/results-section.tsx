...
const STUDENTS: Student[] = [
  ...
  { category: '10th', name: 'Suthar Anjali M.', initials: 'SA', class: 'Class 10th', stream: 'Board Exam', percent: 91, rank: 4, year: '2022', subjects: ['Board Topper'], gradient: 'linear-gradient(135deg,#daa520,#F5C518)' },
